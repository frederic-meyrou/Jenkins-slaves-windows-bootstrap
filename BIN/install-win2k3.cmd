...
XCOPY /E/I/Q/H/K/Y %MASTER_DRIVE%\INSTALL\jdk-8u60-windows-x32\*.* %LOCAL_TOOLS%\JDK1.8\  
...
:SVN
%MASTER_DRIVE%\INSTALL\CollabNetSubversion-client-1.8.14-1-Win32.exe /S /Answerfile=%MASTER_DRIVE%\INSTALL\collabnetSVN.conf /D=%LOCAL_TOOLS%\SVN_1.8 2>> %ERRORLOG%
